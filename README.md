...
Se cambia su estado a anulada.

Se conservan sus datos históricos.

Se restauran las cantidades de productos al stock.

La venta queda disponible para consulta.
...
Operaciones permitidas para ventas e inventario
